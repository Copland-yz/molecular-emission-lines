        ...
        row.forEach(atomicNumber => {
            if (atomicNumber === 0) {
                ...
                if (atomicNumber === 119) {
                    ...
                    realAtomicNumber = 1; // D has atomic number 1
                } else {
